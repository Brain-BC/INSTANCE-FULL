...
class DataBaseRestore(models.TransientModel):
    ...
    db_master_pwd = fields.Char(string="Database Master Password", help="Master Password to restore database")
    backup_location = fields.Char(string="Backup Location",help="Database backup location")
